...
%disp('.....BISEZIONE.....')
[xbisez,xk_bisez,it_bisez]=bisez(f,a,b,tolx); 
...
% %%%%%%%%%%% stima dell'ordine di convergenza %%%%%%%%%%%
 ordinebisez=stima_ordine(xk_bisez,it_bisez)
 ordinefalsi=stima_ordine(xk_falsi,it_falsi)
 ordinecorde=stima_ordine(xk_corde,it_corde)
 ordinenewton=stima_ordine(xk_newton,it_newton)
 ordinesecanti=stima_ordine(xk_secanti,it_secanti)
